...
export class StudentService {
  ...
  //     });
  //     const githubValidator = await this.githubService.validateGithubName(
  //       studentId,
  //       githubName,
  //     );
  //
  ...
  //         `Użytkownik z adresem e-mail: ${email} już istnieje w bazie`,
  //       );
  //     }
  //
  //     const update1 =
  ...
  //       .update('projects');
  //     if (
  //       studentProfileDetails.bonusProjectUrl &&
  //       studentProfileDetails.portfolioUrl
  //     ) {
  //       urlsUpdate
  ...
  //       urlsUpdate.set(setBonusProjectUrl).where('projects.type = :type', {
  //         type: projectTypeEnum.bonusProject,
  //       });
  ...
  //         message:
  //           (update1 as UpdateResult) || (update2 as UpdateResult)
  //             ? 'All affected records' + ' have been successfully updated'
  //             : 'no [students/users/projects] rows affected',
  //       };
  //     }
